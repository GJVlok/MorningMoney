...
class NewEntryTab(ft.Column):
    ...
    def _rebuild_content(self):
        ...
        self.page.update()  # or await self.page.safe_update() if you prefer
    ...
    async def refresh(self):
        ...
        """
        await self.page.run_task(self._rebuild_content)  # run in task if heavy
        if self.refresh_all:
...
#     self.transaction_container.content.controls[1] = new_entry_form(self.page, self.refresh_all)
#     self.page.update()