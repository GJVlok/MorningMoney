...
def build_mobile_ui(page: ft.Page,
    ...
    bottom_nav = ft.BottomAppBar(
        ...
        content=ft.Row([
            ...
            ft.IconButton(ft.Icons.SAVINGS, tooltip="Savings Brag", on_click=lambda _: page.go("/savings_brag")),
    ...
    def route_change(e):
        ...
        elif route == "/savings_brag":
            content_stack.controls.append(savings_brag_tab)
        elif route == "/graphs":
